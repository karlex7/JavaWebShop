 ...
 * @author FRIDAY
 */
@WebServlet(name = "OrderSuccessfullServlet", urlPatterns = {"/orderSuccessfull"})
public class OrderSuccessfullServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Bill b=new Bill(date, c.getIDCustomer(), 2);
